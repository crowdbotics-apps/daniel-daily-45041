"""
Django settings for daniel_daily_45041 project.
...
ROOT_URLCONF = 'daniel_daily_45041.urls'
...
WSGI_APPLICATION = 'daniel_daily_45041.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "daniel_daily_45041 API",
    "DESCRIPTION": "API documentation for daniel_daily_45041 App",
    "VERSION": "v1",
}
